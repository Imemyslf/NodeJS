...
//     const db = getDb();
//     // const cartItem = this.cart.items.find((cp) => {
//     //   console.log(cp);
//     //   return cp.productId.toString() === prodId;
//     // });
//     // console.log("Product found :", cartItem);
...
//       })
//       .then((result) => {
//         console.log("result Inside addnewOrder");
//         this.cart = { items: [] };
...
//       })
//       .catch((err) => {
//         console.log("Error while findind the user", err);
//       });
//   }
